...
# profile-of-open-source-people.pptx

<!-- Source: ~/onedrive/开源之书/2023-06/profile-of-open-source-people.pptx -->

<!-- Total: 40 slides -->

<!-- Part 2/3, slides 16-30 / 40 -->
...
- 作者的一段奇妙经历
- 关于基于互联网创业，改变世界的奇思妙想
- by creating new things, new practices, and new forms of life.
...
- 不是反对一切的破坏者
- Free Software is public in a particular way: it is a self-determining, collective, politically independent mode of creating very complex technical objects that are made publicly and freely available to everyone—a “commons,” in common parlance. It is a practice of working through the promises of equality, fairness, justice, reason, and argument in a domain of technically complex software and networks, and in a context of powerful, lopsided laws about intellectual property.
...
- https://nadiaeghbal.com/oss/  发现更多：Podcast、blog etc.
...
- 终于有人指出房间里大象的存在
- 请环顾四周，那个服务使用到了开源软件
- 这些开源软件背后的作者是否获得了充足的报酬？社会是否给予他们回报？
- 探究的历程：NTP server 作者、Linux Kernel 的后继者……
- 开源软件的可持续性面临的挑战和可能的解决方案
...
- – Harlan Stenn, Network Time Protocol  维护者

---

## Slide 27
- Many of us have a five at the beginning of our ages, while a couple are approaching their 60s. So at some point, we as a community need to start thinking about generational change.……It turns out it's really hard to find people who are maintainers
- Linus Torvalds 在2020年在线北美开源峰会上如此说
...
- 完全不同的视角
- 关注被大众忽略但却非常重要的社会现象
- 为什么GitHub 会成为 social coding 的平台？
- 开源项目的人员构成是什么样子的？
- 这些所谓的开源人都有哪些角色？
- 开源的经济来源的合理性在哪里？
- 开源项目从开发到交付都有哪些开销？
...
- 介绍
- 信息
- 重温 Tim Berners Lee 博士的WWW论文
- 开发者在公开的地方工作，要么被有钱的公司发现，要么就销声匿迹
- 很多人希望获得金钱上的资助
- 从熟悉的同事到完全的陌生人： 开源的社会协作（全新的社会意义）
- 维护者的苦恼：从review代码到沟通交互
- Solo creator 的崛起
...
## Slide 30
- 第一章：Github 作为平台
- 开源历史的演进：现代的开发者根本不在乎（意识形态、理想、自由）
- Git 和 github 究竟是谁成就了谁？
- GitHub 的根本优势：易用、易分享、易发现他人的代码
- JavaScript 项目占尽开源的优势
- GitHub as Social Coding！
