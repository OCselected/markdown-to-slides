...
## Slide 2: 书摘——copyleft 精要

* 视觉隐喻：
  * 无数手掌传递发光种子，长成无锁之树，根系自由交织，四周无围墙，无新增锁链，隐喻自由传播与防限制。
* 显示要点：
  * **书摘：** The central idea of copyleft is that we give everyone permission to run the program, copy the program, modify the program, and distribute modified version-- but not permission to add restrictions o...
