...
* **视觉隐喻：** 左侧 230 亿市场规模柱状图（2025→2026 对比），右侧曾鸣三阶段时间轴高亮第二阶段，底部四厂商 Logo 矩阵（WorkBuddy/百度搭子/千问办公/豆包工作），右下角 Hermes 反向样本徽章
* **显示要点：**
  * **本土 AI 办公市场**：2026 上半年规模 230 亿元，同比增长 47%；密集上线 20+ 款 AI 办公智能体（虎嗅 2026-09-16）
  * **桌面端月活**：17 款主流 AI 原生办公智能体合计 MAU 6000 万（6 月），相比 3 月 2000 万三月翻三倍
  * **头部竞争**：WorkBuddy 1115 万 MAU（7 月榜首）；百度搭子 674 万 MAU 上线 5 个月环比增长 1063.79%，两者合计占整体市场六成
  * **大厂入局**：2026 年中腾讯 WorkBuddy、阿里千问办公、字节豆包工作、百度搭子集中上线
  * **理论坐标**：曾鸣《智能》（2026）三阶段中第二阶段"智能体大爆发"已兑现——从"生成内容"跨越到"办成实事"
  * **Hermes 是一个反向样本**：本土追求"大而全的 Agent 平台"，Hermes Agent（243K star）选择"最小核心 + 开放边缘"——两种截然不同的 Agent 治理哲学
  * **制度含义**：谁定义 Agent 的能力边界、权限范围、审计机制，谁就掌握下一代生产力工具的定义权
* **数据要点：**
  * {'label': '2026 H1 市场规模', 'value': '230 亿元（+47%）'}
  * {'label': '桌面端月活', 'value': '3000 万（7 月）'}
  * {'label': '百度搭子上线', 'value': '5 月 22 日 · 150 版本 · 9 倍月增'}
  * {'label': '付费意愿', 'value': '59.1% 用户愿付费（艾媒）'}
  * {'label': 'Gartner 预测', 'value': '2026 年底 40% 企业应用嵌入 Agent'}
  * {'label': 'Hermes Agent', 'value': '243K star · 397 contributors · 33 releases'}
* **叙事：** 2026 上半年本土 AI 办公市场 230 亿元、同比增长 47%、密集上线 20+ 款产品，曾鸣三阶段中第二阶段"智能体大爆发"已经兑现。腾讯 WorkBuddy、阿里千问办公、字节豆包工作、百度搭子（上线 5 个月迭代 150 版本、环比增长 1063.79%）共同完成了一场关于"Agent 平台 vs 最小核心"的制度性实验——Hermes Agent 是这个实验的反向样本。
...
* **视觉隐喻：** 时间线延续，MCP 捐给 LF 的节点用大号红圈标注；右侧曾鸣《智能》三阶段小卡片，高亮"第二阶段 智能体大爆发"
* **显示要点：**
  * {'head': '理论框架', 'detail': '曾鸣《智能：AI 时代的商业、组织与战略的本质》（2026）提出三阶段：①基础设施成形 ②智能体大爆发 ③AI OS 出现'}
  ...
  * {'head': '本土第二阶段', 'detail': '2026 H1 本土 AI 办公市场 230 亿元、+47%、上线 20+ 款——曾鸣第二阶段在中国的具体形态'}
  * {'head': '制度含义', 'detail': '协议制度化——行政动员失败后的自发秩序'}
* **数据要点：**
  * {'label': 'MCP 捐给 LF', 'value': '2026'}
  * {'label': '本土第二阶段', 'value': '230 亿元 · +47%'}
* **叙事：** 曾鸣《智能》（2026）将 AI 产业化分为三阶段——基础设施成形、智能体大爆发、AI OS 出现——2026 H1 本土 AI 办公市场 230 亿元、同比增长 47%、上线 20+ 款产品，恰好是第二阶段在中国的具体兑现。同期 MCP 从 Anthropic 单厂商私产演化为 Linux Foundation 中立资产，是协议制度化的教科书样本。
